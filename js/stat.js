if (! function (e, n, t, r) {
        ...
        if (o[s] = t, !o[t]) {
            ...
            var u = a.getElementsByTagName("head")[0],
                ...
                p = i(),
                h = "";
            h = e.length - 3 === e.indexOf(".js") ? e : ["//", e, "/source/", n, "/", p, ".", "js"].join(""), l.defer = l.async = !0, l.charset = "utf-8", l.src = h, l.onload = l.onerror = function () {}, u.appendChild(l)
        }
...
Analytics("config", "appnm", "movie"), Analytics("config", "alwaysSendReferrer", !0), Analytics("use", "movie"), Analytics("set", "uid", window.system ? system.uid : ""), window.openPlatform && Analytics("get", "utm", function (e) {
            ...
            if ("file:" !== r) {
                ...
                n.prototype.open = function (n, t, a, s, c) {
                    if (this._method = "string" == typeof n ? n.toUpperCase() : null, t) {
                        if (0 === t.indexOf("http://") || 0 === t.indexOf("https://") || 0 === t.indexOf("//")) this._url = t;
                        else if (0 === t.indexOf("/")) this._url = r + "//" + i + t;
                        else {
                            var u = r + "//" + i + e.location.pathname;
                            u = u.substring(0, u.lastIndexOf("/") + 1), this._url = u + t
                        }
                        var l = this._url.indexOf("?"); - 1 !== l ? (this._searchLength = this._url.length - 1 - l, this._url = this._url.substring(0, l)) : this._searchLength = 0
                ...
                n.prototype.send = function (n) {
                    function t(t, i) {
                        if (0 !== t._url.indexOf(r + "//frep.meituan.net/_.gif")) {
                            for (var o = "browser.ajax", a = [98, 114, 111, 119, 115, 101, 114, 46, 97, 106, 97, 120], s = 0, c = o.length; c > s; s++)
    ...
    }(window, window.XMLHttpRequest, "mta"), mta("create", "5732dc750ea11a1c3db93a1c"), mta("config", "beaconImage", "https://frep.meituan.com/_.gif"), mta("send", "page"),
    function (e, n) {
        "use strict";
        ...
        function p(e, n) {
            var t, r;
            if (o(e.length))
                for (t in e) f(e, t) && n.call(null, t, e[t]);
            else if (r = e.length)
                for (t = 0; t < r; t++) n.call(null, t, e[t])
        }
        ...
        function g(e) {
            if (e.context && D.fetchContext) {
                for (var n = e.context, t = ~~(n.length / 2), r = n.length, i = !1; r--;)
                    if (n[r].length > 300) {
                        i = !0;
                        break
                    }
        ...
        function d(e, n, t, r, i, o) {
            var a, s;
            D.ignoreErrors.test && D.ignoreErrors.test(n) || (n += "", n = x(n, D.maxMessageLength), s = e + ": " + n, s = x(s, D.maxMessageLength), i && i.length ? (t = i[0].filename || t, i.reverse(), a = {
                frames: i
            }) : t && (a = {
                frames: [{
                    filename: t,
        ...
        function b(e) {
            var n = {
                ...
                r = w();
            r && (n.request = r), e = v(n, e), e.tags = v(v({}, D.tags), e.tags), e.extra = v(v({}, D.extra), e.extra), e.extra = v({
                "session:duration": y() - J
            }, e.extra), u(e.tags) && delete e.tags, M && (e.user = M), D.release && (e.release = D.release), a(D.dataCallback) && (e = D.dataCallback(e) || e), e && !u(e) && (a(D.shouldSendCallback) && !D.shouldSendCallback(e) || (L = e.event_id || (e.event_id = O()), C("debug", "Raven about to send:", e), _() && (D.transport || E)({
                url: N,
                auth: {
                    sentry_version: "4",
        ...
        j.wrap = function (e) {
            ...
            function a(e, n, t, r, i) {
                var a = null;
                if (v) j.computeStackTrace.augmentStackTraceWithInitialElement(v, n, t, e), u();
            ...
            function v(e, n) {
                for (var t, i, o, a = /function\s+([_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)?\s*\(/i, s = [], c = {}, u = !1, f = v.caller; f && !u; f = f.caller)
                    if (f !== x && f !== j.report) {
                        if (i = {
                                url: null,
                                func: U,
        ...
        var X = {
            ...
            captureMessage: function (e, n) {
                if (!D.ignoreErrors.test || !D.ignoreErrors.test(e)) return b(v({
                    message: e + ""
                }, n)), X
            },
    ...
    }(window, window.Raven), Raven.config("http://5d54bac77cc04401ba8fca7a7b1d4c8c@sentry7.meituan.com/422", {
